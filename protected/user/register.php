...
<form method="post">
	...
	<div class="form-row">
		<div class="form-group col-md-6">
			<label for="registerEmail">Az e-mail címed</label>
			<input type="email" class="form-control" id="registerEmail" name="email" value="<?=isset($postData) ? $postData['email'] : "";?>">
		</div>
		<div class="form-group col-md-6">
			<label for="registerEmail1">Az e-mail címed megint (Biztos ami biztos ;)</label>
	...
	<div class="form-row">
		<div class="form-group col-md-6">
			<label for="registerPassword">A Jelszavad</label>
			<input type="password" class="form-control" id="registerPassword" name="password" value="">
		</div>
		<div class="form-group col-md-6">
			<label for="registerPassword1">A jelszavad megint</label>
